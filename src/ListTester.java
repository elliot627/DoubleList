...
public class ListTester {
	...
	public static void main(String[] args) {
		...
		bList.add(1,2.0);
		System.out.println(bList);
		System.out.println("Adding 9.0 to position 2");
		bList.add(2,9.0);
		System.out.println(bList);
		...
		System.out.println("Removing 3.0...");
		bList.remove();
		System.out.println("the resulting list is:\n" + bList);
		System.out.println("Adding 4.0 to position 1...");
		bList.add(1,4.0);
		System.out.println("the resulting list is:\n" + bList);
		...
		System.out.println("\nTesting Bubble Sort...");
		System.out.println("Adding 14.0 to position 2..");
		bList.add(2,14.0);
		...
		System.out.println("Adding 5.0 to position 0...");
		bList.add(0,5.0);
